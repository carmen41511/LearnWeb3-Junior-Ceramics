...
export default function Home() {
  ...
  // prompt the user to connect their eth wallet, then return a Web3Provider
  ...
  useEffect(() => {
    if (web3ModalRef.connection  !== "connected"){
  ...
  const connectToSelfID = async() => {
    const ethereumAuthPrivider = await getEthereumAuthProvider();
    connect(ethereumAuthPrivider);
  };
